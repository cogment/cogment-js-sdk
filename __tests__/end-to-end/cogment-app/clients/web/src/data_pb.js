...
goog.exportSymbol('proto.cogment_app.EmmaAction', null, global);
 ...
 * @constructor
 */
proto.cogment_app.EmmaAction = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.cogment_app.EmmaAction, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.cogment_app.EmmaAction.displayName = 'proto.cogment_app.EmmaAction';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {number}
 */
proto.cogment_app.Observation.prototype.getTime = function() {
 ...
 */
proto.cogment_app.Observation.prototype.setTime = function(value) {
 ...
 * @return {!Object}
 */
proto.cogment_app.EmmaAction.prototype.toObject = function(opt_includeInstance) {
  return proto.cogment_app.EmmaAction.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.cogment_app.EmmaAction} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cogment_app.EmmaAction.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.cogment_app.EmmaAction}
 */
proto.cogment_app.EmmaAction.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.cogment_app.EmmaAction;
  return proto.cogment_app.EmmaAction.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.cogment_app.EmmaAction} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.cogment_app.EmmaAction}
 */
proto.cogment_app.EmmaAction.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.cogment_app.EmmaAction.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.cogment_app.EmmaAction.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.cogment_app.EmmaAction} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cogment_app.EmmaAction.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {number}
 */
proto.cogment_app.TimeAction.prototype.getTime = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 1, 0.0));
};
...
/**
 * @param {number} value
 * @return {!proto.cogment_app.TimeAction} returns this
 */
proto.cogment_app.TimeAction.prototype.setTime = function(value) {
  return jspb.Message.setProto3FloatField(this, 1, value);
};
