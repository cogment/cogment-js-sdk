...
_TRIALCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="env_config",
            full_name="cogment_app.TrialConfig.env_config",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_OBSERVATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="time",
            full_name="cogment_app.Observation.time",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
_TIMEACTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="time",
            full_name="cogment_app.TimeAction.time",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
TrialConfig = _reflection.GeneratedProtocolMessageType(
    "TrialConfig",
    (_message.Message,),
    dict(
...
EmmaAction = _reflection.GeneratedProtocolMessageType(
    "EmmaAction",
    (_message.Message,),
    dict(
...
TimeAction = _reflection.GeneratedProtocolMessageType(
    "TimeAction",
    (_message.Message,),
    dict(
