...
class EnvConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"suffix",b"suffix"]) -> None: ...
...
class TrialConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"env_config",b"env_config"]) -> None: ...
