...
- Fix `ReferenceError` to `Buffer` triggered when using the SDK in a web browser

## v2.0.6 - 2023-03-17

### Fixed

- Add missing dependency to `protobufjs-cli`
- Generate process returns non-zero exit code on failure

## v2.0.5 - 2023-03-16

### Fixed

- (Yet another) fix for the npm packaging

## v2.0.4 - 2023-03-16

### Fixed

- Fix the packaging for npm

## v2.0.3 - 2023-03-14

### Changed

- Repository organization updated, no functional changes

## v2.0.2 - 2022-05-12

### Changed

- Update & simplify the readme.md
- Update testing to leverage Cogment >=v2.2.0
...
- Added test for code generation via cogment-js-sdk-generate

### Removed

- Various tooling, including commitizen
...
## [1.25.3](https://github.com/cogment/cogment-js-sdk/compare/v1.25.2...v1.25.3) (2021-06-14)

### Bug Fixes

- **package.json:** typings export fixed ([069d82c](https://github.com/cogment/cogment-js-sdk/commit/069d82ceb3290fabd858703d333bc350d14e7261))
...
# [1.25.0](https://github.com/cogment/cogment-js-sdk/compare/v1.24.0...v1.25.0) (2021-04-16)
...
- **ci:** automate git flow ([d154ed7](https://github.com/cogment/cogment-js-sdk/commit/d154ed7d98b6b74eca2b67d230bdbf8fbb3248b1))
...
- **semantic-release:** use origin repository url ([d435133](https://gitlab.com/ai-r/cogment-js-sdk/commit/d4351331c6ec745d487023bc38f022279dc6575b))

## [1.12.1](https://gitlab.com/ai-r/cogment-js-sdk/compare/v1.12.0...v1.12.1) (2021-02-01)

### Bug Fixes

- **semantic-release:** remove .git extension from https repository url ([09657ca](https://gitlab.com/ai-r/cogment-js-sdk/commit/09657ca02afdc86efdf08fb3e6feda1602be797c))

# [1.12.0](https://gitlab.com/ai-r/cogment-js-sdk/compare/v1.11.3...v1.12.0) (2021-02-01)
...
- trigger release on latest ([0868ac2](https://gitlab.com/ai-r/cogment-js-sdk/commit/0868ac26a1d996767c4f9864a99ef5da7756de00))
- **npm:** package install failing on chmod of bin ([7aefc86](https://gitlab.com/ai-r/cogment-js-sdk/commit/7aefc86915c0c767ae9219dc3cc275b9202ba35a))

## [1.10.3-alpha.1](https://gitlab.com/ai-r/cogment-js-sdk/compare/v1.10.2...v1.10.3-alpha.1) (2021-01-28)
